...
object CityRepository {
    ...
    suspend fun getCityCollection(
        ...
        val cityList = listOf(
            City(1, "New York", "New York", 8537673, -74.006F, 40.7128F, "USA", false, Date(),1),
            City(2, "Los Angeles", "California", 39776830, -118.2437F, 34.0522F, "USA", true, Date(),1),
            City(3, "Paris", "Île-de-France", 2140526, 2.3520F, 48.8566F, "France", false, Date(),1),
            City(4, "London", "Greater London", 8982256, -0.1276F, 51.5072F, "UK", false, Date(),1),
            City(5, "Tokyo", "Kanto", 37435191, 139.6917F, 35.6895F, "Japan", false, Date(),1),
            City(6, "Sydney", "New South Wales", 5312163, 151.2093F, -33.8688F, "Australia", false, Date(),1),
            City(7, "Toronto", "Ontario", 2731571, -79.3832F, 43.6511F, "Canada", false, Date(),1),
            City(8, "Dubai", "Dubai", 3137000, 55.2708F, 25.276987F, "UAE", false, Date(),1),
            City(9, "Mumbai", "Maharashtra", 12442373, 72.8777F, 19.0760F, "India", false, Date(),1),
            City(10, "Rio de Janeiro", "Rio de Janeiro", 12, -43.1729F, -22.9068F, "Brazil", true, Date(),1)
        )
